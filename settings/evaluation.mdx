...
A configuração da avaliação é feita no arquivo de configuração pelo campo **evaluation**. A avaliação é feita após todos os scripts executarem e é responsavel por gerar o [resultado da peça](/settings/process-result), que pode ser:
